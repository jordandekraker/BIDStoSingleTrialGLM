    ...
    case 1
        ...
        parfor i=1:length(subject_id)
            ...
            for j=1:length(sub(i).run)
                ...
                matlabbatch=load(strcat(folderpath,'template_AvsB.mat'));
                ...
                parsave(strcat(run_temp,'/','step1.mat'),matlabbatch);
                %delete('SPM.mat');   
                ...
                for trial = 1:length(sub(i).runevent{1,j})
                    ...
                    matlabbatch=load(strcat(run_temp,'/','step1.mat'))%load matlabbatch
